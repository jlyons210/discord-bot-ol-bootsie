...
module.exports.engageConversationProbably = async function(discordMessage, messageHistory) {

  // PICK UP HERE
  // Need to review all non-prompt messages past last engagement timestamp.
  // Need to update timestampe when participating in conversation.
...
module.exports.reactToMessageProbably = async function(discordMessage, messageText) {
